...
- **Gerar Histórico de Ações:** O site deverá gerar um histórico de todas as ações feitas pelos usuários, para se ter um monitoramento. Para que isso seja feito, será necessário armazenar os seguintes dados: Descrição da Ação e Usuário que efetuou a ação.
